...
c.colors.completion.fg = [fg1, dark_green, bright_yellow]
...
c.colors.completion.category.fg = bright_green
...
c.colors.tabs.indicator.stop = dark_cyan

# Color for the tab indicator on errors.
c.colors.tabs.indicator.error = dark_red
